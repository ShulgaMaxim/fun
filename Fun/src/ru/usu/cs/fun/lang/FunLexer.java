...
import ru.usu.cs.fun.front.FloatNumber;
...
import ru.usu.cs.fun.front.Str;
...
public class FunLexer extends GenericLexer {
	...
	static {
		...
		Recognizer string = new Str();
		Recognizer flt = new FloatNumber();
		recognizers = new Recognizer[] { let, fun, eq, semicolon, open, close,
				intNumber, name, space, string, flt };
	}
